        ...
        <>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between bg-[rgb(245,159,10)] p-16">
                ...
                <button className="mt-4 md:mt-0 md:ml-6 p-4 flex space-x-16">
                    <img src={Whatsapp} alt="WhatsApp" className="w-12 hover:cursor-pointer" />
                    <img src={Mail} alt="Mail" className="w-12 hover:cursor-pointer" />
                    <img src={Insta} alt="Instagram" className="w-12 hover:cursor-pointer" />
                </button>
            </div>
        </>
    );
